...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><?php print_lang('view_warehouses'); ?></h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-code">
                                        <th class="title"> <?php print_lang('code'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-location">
                                        <th class="title"> <?php print_lang('location'); ?>: </th>
                                        <td class="value">
                                    ...
                                    <tr  class="td-project_id">
                                        <th class="title"> <?php print_lang('project_id'); ?>: </th>
                                        <td class="value">
                            ...
                            <div class="dropup export-btn-holder mx-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="btn btn-sm btn-info"  href="<?php print_link("warehouses/edit/$rec_id"); ?>">
                                            <i class="fa fa-edit"></i> <?php print_lang('edit'); ?>
                                        </a>
                                        <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("warehouses/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
